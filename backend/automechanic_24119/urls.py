"""automechanic_24119 URL Configuration
...
admin.site.site_header = "AutoMechanic"
admin.site.site_title = "AutoMechanic Admin Portal"
admin.site.index_title = "AutoMechanic Admin"

# swagger
api_info = openapi.Info(
    title="AutoMechanic API",
    default_version="v1",
    description="API documentation for AutoMechanic App",
)
